...
variable "project_for_templates" {
  type        = string
  description = "Project where the account templates can be found"
}

variable "vended_applications_project" {
  type        = string
  description = "Project where the user-facing repos will be created"
}

variable "vended_baselines_project" {
  type        = string
  description = "Project where vended baselines will be forked into"
}
...
variable "ssh_key" {
  type        = string
  description = "the name of the SSH Key for GitHub authentication"
}
